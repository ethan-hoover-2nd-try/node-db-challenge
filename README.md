...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  ...
  - A relational database is structure of the data which is stored, where as SQL is the query selector language which can be used for adding, removing, selecting and updating information

- [ ] Why do tables need a `primary key`?

  - tables need primary keys to uniquely identify a row on a table for which we can then use to build relationships with other tables through things like foreign keys.
...
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
  ...
  - to have a many to many relationship between two tables you have to have a third table that references both tables with a foreign key.
